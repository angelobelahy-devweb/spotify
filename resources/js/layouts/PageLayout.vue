  ...
  <div class="relative w-full flex max-h-screen bg-[#212121] overflow-y-hidden">
    ...
    <aside :class="sidebarOpen ? 'w-60' : 'w-15'" class=" p-2 bg-[#212121] text-white transition-all duration-300 ">
      ...
      <nav class="mt-5">
        ...
        <ul>
          <Link href="" class="flex gap-2 items-center p-3 hover:bg-[#057430d0] cursor-pointer rounded">
            <svg
    ...
    <div class="flex-1 flex flex-col">
      ...
      <main
        ...
        "
        :style="{
          backgroundImage: `linear-gradient(#212121de, #212121c7),url(${backgroundImage})`
        }"
      >
